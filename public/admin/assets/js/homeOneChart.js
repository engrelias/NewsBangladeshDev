  ...
  var options = {
    series: [{
      name: 'Series 1',
      data: [10, 20, 30, 20, 32, 20, 35, 40, 30, 20, 51, 42]
    }],
    chart: {
      height: 350,
      type: 'area'
    ...
    xaxis: {
      ...
      categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], // Match number of data points
    },
    tooltip: {
      x: {
        format: undefined // Removed datetime format
      },
    },
  };
